...
<?php
//Define Title and include Header Template
            ...
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                        <div class="text-uppercase">Design &middot; Development &middot; Data Strategy</div>
                    </div>
                    <div class="fs-3 fw-light text-muted">I help businesses</div>
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Streamline processes
and accelerate growth</span></h1>
