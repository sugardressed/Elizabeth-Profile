                ...
                <div class="col-lg-8 col-xl-6">
                    ...
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="contact.php" method="post">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <!-- Not valid data this is for testing only
...
// Evaluate if the user is selecting any additional topping.
if(isset($_POST['name'])) {

    print "<br>Thank you for your interest <b>$name</b><br>\n";


} 

else{
    //If no additional topping a message will display and base cost will show.
    print "<br>Missing Data: $name. Your phone number is $phone.<br> <b>Your Message is $message.\n";
}
    ?>
